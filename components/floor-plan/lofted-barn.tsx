...
export function LoftedBarn() {
  ...
  const showTipAt = useCallback((cx: number, ty: number, label: string, isRotated: boolean) => {
    ...
    tip.setAttribute("transform", `translate(${sx - tw / 2},${sy})`);
  ...
  const handleSvgClick = useCallback((e: React.MouseEvent<SVGSVGElement>) => {
    ...
    if (tipActiveRef.current && !target.classList.contains("shelf-hl") && !target.closest(".wb-area") && !target.closest(".mower-area")) {
      hideTip();
    }
    if (wbTipOnRef.current && !target.closest(".wb-area")) hideWbTip();
    if (mowerTipOnRef.current && !target.closest(".mower-area")) hideMowerTip();
  }, [hideTip, hideWbTip, hideMowerTip]);
        ...
        <div className="fp-plan-wrap">
          ...
          >
            ...
            >
              ...
              {[[165, 211], [243, 289], [321, 362], [438, 480], [512, 558], [590, 636]].map(([a, b]) => (
                <g key={`ad${a}`}>
                  ...
                  <text x={(a + b) / 2} y="340" textAnchor="middle" fill="#000" fontSize="14" fontWeight="600">3&apos;-0&quot;</text>
                </g>
              ))}

              {/* Mower clearance dim */}
              <line x1="460" y1="305" x2="460" y2="383" stroke="#000" strokeWidth="0.6" />
              <line x1="452" y1="305" x2="468" y2="305" stroke="#000" strokeWidth="0.6" />
            ...
            <g ref={wbTipRef} opacity="0" pointerEvents="none">
              <rect x="0" y="0" width="268" height="52" rx="8" fill="#fff" stroke="#000" strokeWidth="1.5" />
              <text x="134" y="32" textAnchor="middle" fill="#000" fontSize="20" fontWeight="700">Workbench: 72&quot;×30&quot; 15 sq ft</text>
            </g>
